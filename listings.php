...
<head>
   ...
   <title>All Boarding Listings</title>
...
<section class="listings">
   ...
   <h1 class="heading">All Boarding listings   <button id="useMap"><a href="pages/Boarding_map.php"><b>Go to Map  </b><i class="fa-solid fa-location-dot"></i></a></button></h1> 
