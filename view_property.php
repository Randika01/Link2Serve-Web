...
<section class="view-property">
   ...
   <?php
      ...
      if($select_properties->rowCount() > 0){
         ...
         function format_address_for_maps($address) {
            ...
            $google_maps_url = format_address_for_maps($fetch_property['address']);
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <p class="location"><i class="fas fa-map-marker-alt"></i><a href="<?= $google_maps_url ?>" target="_blank"><?= $fetch_property['address']; ?></a></p>
      <div class="info">
         <p><i class="">LKR</i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>bed :</i><span><?= $fetch_property['bed']; ?> beds</span></p>
            <p><i>bathroom :</i><span><?= $fetch_property['bathroom']; ?> bathrooms</span></p>
            <p><i>balcony :</i><span><?= $fetch_property['balcony']; ?> balconys</span></p>
         </div>
         <div class="box">
            <p><i>No. of students:</i><span><?= $fetch_property['student']; ?> students</span></p>
            <p><i>University related:</i><span><?= $fetch_property['university']; ?></span></p>
            
            <p><i>No. of rooms:</i><span><?= $fetch_property['room']; ?></span></p>
            <p><i>Address:</i><span><?= $fetch_property['address']; ?></span></p>
            <p><i>Location:</i><span><?= $fetch_property['location']; ?></span></p>
            <p><i>Premises:</i><span><?= $fetch_property['premises']; ?></span></p>
