...
<section class="view-property">
   ...
   <h1 class="heading">Boarding place details</h1>
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <p class="location"><i class="fas fa-map-marker-alt"></i><span><a href="<?= $google_maps_url ?>" target="_blank"><?= $fetch_property['address']; ?></a></span></p>
      <div class="info">
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>Beds :</i><span><?= $fetch_property['bed']; ?></span></p>
